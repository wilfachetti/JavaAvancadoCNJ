...
import br.cnj.projeto.util.KeycloakLogoutHandler;
...
public class KeycloakSecurityConfig {
    ...
    public SecurityFilterChain resourceServerFilterChain(HttpSecurity http) throws Exception {
        http.authorizeHttpRequests(authorize -> authorize
                .requestMatchers(new AntPathRequestMatcher("/api/casos*", HttpMethod.OPTIONS.name()))
                .hasRole("user")
                //.permitAll()
        ...
        http.oauth2Login(Customizer.withDefaults())
               .logout(logout -> logout.addLogoutHandler((LogoutHandler) keycloakLogoutHandler).logoutSuccessUrl("/"));
